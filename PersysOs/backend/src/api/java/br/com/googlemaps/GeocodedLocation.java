...
public class GeocodedLocation implements Serializable {
    ...
    /**
     * This should be the original input address to the {@link com.googlemaps.LocationProvider}
     */
    ...
    /**
     * Should be true if the {@link com.googlemaps.LocationProvider} returned more than one result for the input address
     */
