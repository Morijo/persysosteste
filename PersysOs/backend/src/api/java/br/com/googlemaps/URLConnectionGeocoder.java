...
/**
 * {@link com.googlemaps.LocationProvider} shell implementation that fetches data from an URL and delegates to implementing class to decode
 */
...
public abstract class URLConnectionGeocoder<T extends GeocodedLocation> implements LocationProvider<T> {
     ...
     * @return full URL
     * @throws java.io.UnsupportedEncodingException if subclass uses {@link java.net.URLEncoder} and it fails
     */
    protected abstract String getURL(String address) throws UnsupportedEncodingException;

    /**
     * Creates {@link com.googlemaps.GeocodedLocation} objects from response stream
     * @param address input address
     * @param input response stream as string
     * @return collection of {@link com.googlemaps.GeocodedLocation} objects
     * @throws com.googlemaps.GeocodingException
     */
