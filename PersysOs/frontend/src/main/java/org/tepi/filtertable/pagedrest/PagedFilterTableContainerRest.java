...
public class PagedFilterTableContainerRest<T extends Container.Indexed & Container.Filterable & Container.ItemSetChangeNotifier>
    ...
    public PagedFilterTableContainerRest(T container) {
