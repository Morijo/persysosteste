...
public class NumberFilterPopup extends CustomField<NumberInterval> {
    ...
    private static final String DEFAULT_LT_PROMPT = "Menor que";
    private static final String DEFAULT_GT_PROMPT = "Maior que";
    private static final String DEFAULT_EQ_PROMPT = "Igual";
    private static final String DEFAULT_OK_CAPTION = "Ajustar";
    private static final String DEFAULT_RESET_CAPTION = "Limpar";
    private static final String DEFAULT_VALUE_MARKER = " ";
