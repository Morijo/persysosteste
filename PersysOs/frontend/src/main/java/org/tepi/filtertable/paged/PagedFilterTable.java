...
extends FilterTable {
	...
	static {
		bundle = ResourceBundle.getBundle("com/persys/frontend/view",
				Locale.getDefault());
	}
	...
	protected VerticalLayout exportar(String title){
		...
		PdfExporter pdfExporter = new PdfExporter(this.getContainerDataSource(),this.getColumnHeaders());
			pdfExporter.setCaption(bundle.getString("exporttopdf"));
			...
			csvExporter.setCaption(bundle.getString("exporttocsv"));
			...
			excelExporter.setCaption(bundle.getString("exporttoexcel"));
    ...
    public HorizontalLayout createControls() {
        Label itemsPerPageLabel = new Label(bundle.getString("itemsperpage"));
        ...
        itemsPerPageSelect.setVisible(false);
        itemsPerPageSelect.select("50");
        Label pageLabel = new Label(bundle.getString("page"), ContentMode.HTML);
        ...
        Label separatorLabel = new Label(bundle.getString("number"), ContentMode.HTML);
        ...
        buttonReload = new Button(bundle.getString("reload"));
  		buttonReload.setWidth("-1px");
  		buttonReload.setHeight("-1px");
  		buttonReload.setVisible(true);
  		controlBar.addComponent(buttonReload);
  	
        Button  buttonExportar = new Button(bundle.getString("export"),new ClickListener() {
            @Override
            public void buttonClick(ClickEvent event) {
                        ...
                        addComponent(new HorizontalLayout() {
                            {
                                ...
                                Button ok = new Button(bundle.getString("close"));
    ...
    public void setContainerDataSource(Container newDataSource) {
        if (!(newDataSource instanceof Container.Indexed)
            ...
            throw new IllegalArgumentException(bundle.getString("msgerror"));
        }
