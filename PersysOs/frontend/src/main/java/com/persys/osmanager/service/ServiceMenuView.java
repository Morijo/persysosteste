 ...
 * @version 1.0.0
 * @since 18/02/2013 View Menu serviço e procedimento
 */
public class ServiceMenuView extends HorizontalLayout implements View{
	...
	private void buildMenu(RestMBClient client) {
		content.addComponent(new ServiceView(client));
		createNav(bundle.getString("entity"), content.getComponent(0));
		createNav(bundle.getString("procedure"),new ProcedimentoView(client));
