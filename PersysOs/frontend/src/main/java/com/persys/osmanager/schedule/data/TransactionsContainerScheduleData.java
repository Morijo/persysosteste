package com.persys.osmanager.schedule.data;
 ...
 *
 */
public class TransactionsContainerScheduleData extends TransactionsContainer<IOrdem> {

	private static final long serialVersionUID = 1L;

	public TransactionsContainerScheduleData() {
