...
public class ReportsView extends HorizontalLayout implements View {
    ...
    private Component buildDraftsView() {
        ...
        center.setSizeFull();
        center.setCaption("Todos Relátorios");
        ...
        Label draftsTitle = new Label("Relatórios");
        ...
        final Button delete = new Button("Remover");
    ...
    private HorizontalLayout createEditorInstance(int which,
        ...
        if (which == 1) {
            ...
            editor.setCaption("Novo Relatório " + (df.format(new Date()))
                    + " (" + draftCount + ")");
        }
        ...
        wrap.addComponent(l);
        caption = new Label("Top 10 serviços");
        caption.setSizeUndefined();
        wrap.addComponent(caption);
        ...
        wrap.addComponent(l);
        caption = new Label("Média por funcionário");
        caption.setSizeUndefined();
        wrap.addComponent(caption);
